<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TaiKhoan_HienThi.ascx.cs" Inherits="ShopThoiTrang.cms.admin.TaiKhoan.TaiKhoan_HienThi" %>
<div class="head">
...
<script type="text/javascript">
    function XoaTaiKhoan(TenDangNhap) {
        if (confirm("Bạn chắc chắn muốn xóa tài khoản này")) {
            ...
            $.post("cms/admin/TaiKhoan/Ajax/XoaTK.aspx",
                {
                    "ThaoTac": "XoaTaiKhoan",
