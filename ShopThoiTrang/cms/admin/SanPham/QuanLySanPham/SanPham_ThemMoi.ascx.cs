...
namespace ShopThoiTrang.cms.admin.SanPham.QuanLySanPham
{
    public partial class SanPham_ThemMoi : System.Web.UI.UserControl
    {
        ...
        {
            DataTable dt = new DataTable();
            dt = Database.Size.Thongtin_Size();
            ddlSize.Items.Clear();
        ...
        {
            DataTable dt = new DataTable();
            dt = Database.ChatLieu.Thongtin_Chatlieu();
        ...
        {
            DataTable dt = new DataTable();
            dt = Database.DanhMuc.Thongtin_Danhmuc_by_MaDMCha(MaDMCha);
        ...
        protected void btThemMoi_Click(object sender, EventArgs e)
        {
            if (thaotac == "ThemMoi")
            {
                ...
                Database.SanPham.Sanpham_Inser(tbTenSanPham.Text, ddlMau.SelectedValue, ddlSize.SelectedValue, ddlChatLieu.SelectedValue, flAnhDaiDien.FileName, tbSoLuong.Text, tbGiaBan.Text, tbMoTa.Text, tbNgayTao.Text, tbNgayHuy.Text, ddlDanhMucCha.SelectedValue, ddlNhom.SelectedValue, "");
            ...
            else
            {
                ...
                Database.SanPham.Sanpham_Update(id, tbTenSanPham.Text, ddlMau.SelectedValue, ddlSize.SelectedValue, ddlChatLieu.SelectedValue, tenAnhDaiDien, tbSoLuong.Text, tbGiaBan.Text, tbMoTa.Text,
