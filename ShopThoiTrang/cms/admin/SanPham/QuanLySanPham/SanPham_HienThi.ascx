<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SanPham_HienThi.ascx.cs" Inherits="ShopThoiTrang.cms.admin.SanPham.QuanLySanPham.SanPham_HienThi" %>
<div class="head">
    Các sản phẩm đã tạo. 
...
<script type="text/javascript">
    function XoaSanPham(MaSP) {
        if (confirm("Bạn chắc chắn muốn xóa sản phẩm này")) {
            ...
            $.post("cms/admin/SanPham/QuanLySanPham/Ajax/XoaSanPham.aspx",
                {
                    "ThaoTac": "XoaSanPham",
                    "MaSP": MaSP
                },
