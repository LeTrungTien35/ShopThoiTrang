<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChiTietSanPham.ascx.cs" Inherits="ShopThoiTrang.cms.display.SanPham.ChiTietSanPham" %>
...
<div class="chitietsp">
    ...
    <div class="baochitiet">
        ...
        <div class="product-price">
            <span><asp:Literal ID="ltrGiaSP" runat="server"></asp:Literal>-VND</span>
        </div>
        <div class="thongso">
            <div class="size">
